...
const ROUTE=[
  ...
  {n:"북삼",d:"칠곡"},
  {n:"왜관",d:"칠곡군"},
  {n:"서대구",d:"KTX 환승",x:["KTX"],xc:["#C0392B"]},
  {n:"원대",d:"(개통 예정)",future:true},
  {n:"대구",d:"지하철 1호선 환승",x:["지하철 1호선"],xc:["#D4700A"]},
  {n:"동대구",d:"KTX·SRT·지하철 환승",x:["KTX","SRT","지하철"],xc:["#C0392B","#6B21A8","#D4700A"]},
  {n:"고모",d:"경산"},
  {n:"가천",d:"경산"},
  {n:"경산",d:"시/종착역"},
];
function MapTab() {
  return <div style={scrollS}>
    <div style={cardS}>
      <SecHead title="대경선 노선도"/>
      <div style={{padding:'14px 16px'}}>
        <div style={{position:'relative',paddingLeft:22}}>
          <div style={{position:'absolute',left:8,top:12,bottom:12,width:3,
            background:`linear-gradient(to bottom,${C.accent},${C.blue})`,borderRadius:2}}/>
          {ROUTE.map((s,i)=>(
            <div key={s.n} style={{display:'flex',alignItems:'center',gap:10,
              marginBottom:i<ROUTE.length-1?22:0,position:'relative'}}>
              <div style={{position:'absolute',left:-16,
                width:s.x?14:s.future?8:10,height:s.x?14:s.future?8:10,borderRadius:'50%',zIndex:1,
                background:s.future?'transparent':s.x?C.accent:C.text,
                border:`2px solid ${s.future?C.muted:s.x?C.accent+'88':C.border}`,
                boxShadow:s.x?`0 0 8px ${C.accent}66`:'none'}}/>
              <div>
                <div style={{display:'flex',alignItems:'center',gap:6}}>
                  <span style={{fontSize:14,fontWeight:s.x?700:500,
                    color:s.future?C.muted:s.x?C.accent:C.text}}>
                    {s.n}{!s.future?'역':''}
                  </span>
                  {s.future&&<span style={{fontSize:10,color:C.muted,background:C.surf,
                    borderRadius:4,padding:'1px 5px',border:`1px solid ${C.border}`}}>개통예정</span>}
                </div>
                <div style={{fontSize:11,color:C.muted}}>{s.d}</div>
                {s.x&&<div style={{display:'flex',gap:4,flexWrap:'wrap',marginTop:2}}>
                  {s.x.map((x,xi)=><span key={x} style={{fontSize:10,fontWeight:700,
                    background:s.xc[xi]+'22',color:s.xc[xi],
                    border:`1px solid ${s.xc[xi]}44`,borderRadius:4,padding:'1px 5px'}}>
                    🔗 {x}</span>)}
                </div>}
              </div>
            </div>
    ...
    <div style={cardS}>
      <SecHead title="요금 안내 (성인 교통카드)"/>
      <div style={{padding:'12px 14px'}}>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:10}}>
          {[['구미 ↔ 경산','2,800원~'],['구미 ↔ 동대구','2,600원~'],
            ['구미 ↔ 대구','2,400원~'],['경산 ↔ 대구','1,700원~'],
            ['경산 ↔ 동대구','1,500원'],['대구 ↔ 동대구','1,500원']].map(([l,v])=>(
            <div key={l} style={{background:C.surf,borderRadius:8,padding:'8px 10px',border:`1px solid ${C.border}`}}>
  ...
  return <>
    ...
    <div style={{fontFamily:"'Noto Sans KR','Apple SD Gothic Neo',sans-serif",
      ...
      <div style={{background:C.surf,borderBottom:`1px solid ${C.border}`,padding:'10px 16px 9px',flexShrink:0}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          <div style={{display:'flex',alignItems:'center',gap:9}}>
            <div style={{background:`linear-gradient(135deg,${C.accent},#e63600)`,borderRadius:8,
              width:32,height:32,display:'flex',alignItems:'center',justifyContent:'center',
              fontSize:13,fontWeight:900,color:'#fff',letterSpacing:-1,flexShrink:0}}>대경</div>
            <div>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',overflow:'hidden'}}>
        {tab===0&&<NextTab nowM={nowM} hol={hol}/>}
